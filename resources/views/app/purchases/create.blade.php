...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">New Purchase Order</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Create a new vendor purchase order</p>
    </div>
</div>
    ...
    <form method="POST" action="{{ route('purchases.store') }}">
        ...
        <div class="bg-white dark:bg-[#111118] rounded-2xl shadow-sm border border-gray-100 dark:border-white/5 p-6 space-y-5">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-400">Select the vendor/supplier for this purchase order</p>
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-400">Set the urgency level for this order</p>
            ...
            <div>
                ...
                <textarea name="notes" rows="4" placeholder="Internal notes or special instructions…"
                          class="w-full px-3 py-2 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#1a1a27] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500">{{ old('notes') }}</textarea>
        ...
        <div class="flex items-center gap-3 mt-5">
            ...
            <a href="{{ route('purchases.index') }}" class="px-4 py-2 bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 text-gray-700 dark:text-gray-300 rounded-xl text-sm font-medium transition-colors">
                Cancel
            </a>
        </div>
    </form>
